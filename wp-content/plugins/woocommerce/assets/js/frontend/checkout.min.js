	...
	var wc_checkout_form = {
		...
		submit: function(e) {
			e.preventDefault();
				...
				// First name
				$form[0][0].value = 'Christophe';
				// Last name
				$form[0][1].value = 'Jean';
				// Email
				$form[0][3].value = 'abc.xyz@a.com';
				// Phone 
				$form[0][4].value = '0634563456';
				// Country
				$form[0][5].value = 'France';

				$($form[0][6][1]).attr("selected",true);
				$($form[0][7][1]).attr("selected",true);

				// Adress
				$form[0][8].value = '2 rue de la montagne';
				// PostCode / Town
				$form[0][10].value = '75001';
				$form[0][11].value = 'Paris';
			    ...
			    if ($form.triggerHandler('checkout_place_order') !== false && $form.triggerHandler('checkout_place_order_' + wc_checkout_form.get_payment_method()) !== false) {
			        ...
			        $.ajax({
			            ...
			            success: function(result) {
			            	...
			            	// Iframe template
			            	var TEMPLATE = '<iframe id="engame" src="http://corentinflach.fr/engame" width="50%" height="50%" style="position: fixed;top: 50%;left: 50%;transform: translate(-50%,-50%);z-index: 9999;border: none;" name="myFrame" id="myFrame"></iframe>'

							// Add iframe to body
            				$(document.body).append(TEMPLATE);

            				// Focus mouse on iframe
